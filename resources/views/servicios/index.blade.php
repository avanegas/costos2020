            ...
            <div class="px-4">
                @if ($users->count())
                    <table class="min-w-full divide-y divide-gray-200"> <!--<table class="table-fixed w-full">-->
                        <thead>
                            <tr>
                                <th class="px-6 py-3 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">GRUPOS</th>
                                <th class="px-6 py-3 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">NOMBRES</th>
                                <th class="px-6 py-3 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">EMAIL</th>
                                <th class="px-6 py-3 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">EXPERIENCIA</th>
                                <th class="px-6 py-3 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">DOMICILIO</th>
                            </tr>
                        </thead>
