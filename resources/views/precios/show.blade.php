    ...
    <div class="container mx-auto mt-4 px-4 py-2">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="flex items-center justify-between py-2 px-6">
                <div>
                    ...
                    <span class="ml-1 text-lg text-gray-600 font-normal">INFOasistencia</span>
                </div>
                <div class="border rounded-lg px-1" style="padding-top: 2px;">
                    <button type="button" class="leading-none rounded-lg transition ease-in-out duration-100 inline-flex cursor-pointer hover:bg-gray-200 p-1 items-center"> Excel
                    </button>
                </div>
            </div>
        </div>
        ...
        <table class="border-collapse w-full mb-4">
            <thead>
                ...
                <td class="px-2 bg-gray-100 text-gray-600 border border-gray-300 text-sm font-bold lg:table-cell" >{{$precio->updated_at->isoFormat('MMMM Do YYYY')}}</td>
                </tr>
                <tr>
